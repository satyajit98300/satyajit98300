  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Home, [{
    ...
    value: function componentDidMount() {
      ...
      function moveBackground() {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_10___default()('.bg').css({
      ...
      jquery__WEBPACK_IMPORTED_MODULE_10___default()(window).on('mousemove click', function (e) {
        var lMouseX = Math.max(-100, Math.min(100, jquery__WEBPACK_IMPORTED_MODULE_10___default()(window).width() / 2 - e.clientX));
        var lMouseY = Math.max(-100, Math.min(100, jquery__WEBPACK_IMPORTED_MODULE_10___default()(window).height() / 2 - e.clientY));
      ...
      jquery__WEBPACK_IMPORTED_MODULE_10___default()(document).ready(function () {
        jquery__WEBPACK_IMPORTED_MODULE_10___default()("#bb-nav-last").click(function () {
          jquery__WEBPACK_IMPORTED_MODULE_10___default()(this).parents(".body-wrapper").addClass("hide-message");
        });
        jquery__WEBPACK_IMPORTED_MODULE_10___default()("#bb-nav-first").click(function () {
          jquery__WEBPACK_IMPORTED_MODULE_10___default()(this).parents(".body-wrapper").removeClass("hide-message");
        });
      }); /// Video Script Start
      ...
      function getStream() {
        jquery__WEBPACK_IMPORTED_MODULE_10___default()("#preview").hide();
        jquery__WEBPACK_IMPORTED_MODULE_10___default()("#loader").show();
      ...
      function gotStream(stream) {
        jquery__WEBPACK_IMPORTED_MODULE_10___default()("#preview").show();
        jquery__WEBPACK_IMPORTED_MODULE_10___default()("#loader").hide();
    ...
    value: function render() {
      ...
      }, "Want to schedule a meeting for the future? Click ", __jsx("a", {
        id: "bb-nav-last",
        href: "#",
        __self: this,
        __source: {
...
//# sourceMappingURL=index.js.f5bc1c9e1bc2d162587f.hot-update.js.map