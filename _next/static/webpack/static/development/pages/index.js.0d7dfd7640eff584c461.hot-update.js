        ...
        onSubmit: function onSubmit(values, _ref) {
          ...
          setTimeout(function () {
            var formData = {
              ...
              meeting_pin: values.meeting_pin,
              meeting_slug: _this.slugify(values.meeting_name)
            };
            ...
            if (MeetingData.data.status == "success") {
              ...
              document.cookie = "participant_name=" + _this.participant_name;
              document.cookie = "meeting_pin=" + _this.meeting_pin;
              document.cookie = "meeting_name=" + _this.meeting_name;
              ...
              _this.$toast.success("Please wait...").goAway(3000);

              _this.$router.push("/" + _this.slugify(_this.meeting_name));
            } else {
              _this.$toast.error("Something went wrong. Please try again.").goAway(3000);
            }
...
//# sourceMappingURL=index.js.0d7dfd7640eff584c461.hot-update.js.map