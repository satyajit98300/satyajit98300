...
var JoinButtonText = 'Join meeting';

var querystring = __webpack_require__(/*! query-string */ "./node_modules/query-string/index.js");


var base_url = 'https://cf96531b7g.execute-api.us-east-1.amazonaws.com/production';
...
var Home = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Home, [{
    ...
    value: function SubmitJoinForm(fdata) {
      ...
      var MeetingData = axios__WEBPACK_IMPORTED_MODULE_8___default.a.post(base_url + "/join-meeting", formData); // If all good, redirect to meeting page.
      ...
      if (MeetingData.data.status == "success") {
        ...
        next_router__WEBPACK_IMPORTED_MODULE_14___default.a.push('/meeting?meeting_id' + this.slugify(this.meeting_name));
      } else {
...
//# sourceMappingURL=index.js.6af451a799845ef0259c.hot-update.js.map